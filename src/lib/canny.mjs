// Adapted from https://github.com/yuta1984/yuta1984.github.io/tree/master/canny
...
var Util;
  ...
  GrayImageData = (function() {
     ...
     */
      ...
      GrayImageData.prototype.grayFunction = function (r, g, b) {
          return Math.round (0.298 * r + 0.586 * g + 0.114 * b);
      }
      GrayImageData.prototype.redFunction = function (r, g, b) {
          return r;
      }
      GrayImageData.prototype.greenFunction = function (r, g, b) {
          return g;
      }
      GrayImageData.prototype.blueFunction = function (r, g, b) {
          return b;
      }

    GrayImageData.prototype.loadCanvas = function(canvas, grayFunction) {
      var b, ctx, d, g, i, r, rawdata, x, y, _i, _len;
      ctx = canvas.getContext('2d');
      rawdata = ctx.getImageData(0, 0, canvas.width, canvas.height).data;
      x = 0;
      y = 0;
        if (grayFunction === undefined) grayFunction = GrayImageData.prototype.grayFunction;
      for (i = _i = 0, _len = rawdata.length; _i < _len; i = _i += 4) {
        d = rawdata[i];
        r = rawdata[i];
        g = rawdata[i + 1];
        b = rawdata[i + 2];
        this.data[x][y] = grayFunction (r, g, b);
        if (x === this.width - 1) {
          x = 0;
          y += 1;
        } else {
    ...
    GrayImageData.prototype.drawOn = function(canvas, pixelColor) {
      ...
      return ctx.putImageData(imgData, 0, 0, pixelColor);
    };
...
var nms;
  ...
  CannyJS.canny = function(canvas, ht, lt, sigmma, kernelSize, greyFunction) {
    var imgData;
    if (ht == null) {
      ht = 100;
    }
    ...
    imgData.loadCanvas(canvas, greyFunction);
